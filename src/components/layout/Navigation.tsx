...
export default function Navigation() {
  ...
  const handleBookNow = () => {
    router.push('/booking'); // Or appropriate booking route
  };

  const handleDestinations = () => {
    router.push('/destinations'); // Choose appropriate destinations route
  };
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Button variant="ghost" size="sm" onClick={handleDestinations}>
              Destinations
            </Button>
            <Button size="sm" className="group" onClick={handleBookNow}>
              Book Now
        ...
        >
          <div className="px-2 pt-2 pb-3 space-y-1 border-t">
            ...
            <div className="pt-4 flex flex-col space-y-2">
              <Button variant="ghost" className="justify-start" onClick={handleDestinations}>
                Destinations
              </Button>
              <Button className="justify-start group" onClick={handleBookNow}>
                Book Now
                <ArrowRight className="ml-2 size-4 transition-transform group-hover:translate-x-1" />
              </Button>
            </div>
