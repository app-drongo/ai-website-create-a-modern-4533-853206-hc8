  ...
  const plans = [
    {
      ...
      description: 'Elegant 1-bedroom with partial ocean views',
      price: '$285',
      period: '/night',
      badge: null,
      features: [
    ...
    },
    {
      ...
      description: 'Premium 2-bedroom directly on Miami Beach',
      price: '$485',
      period: '/night',
      badge: 'Most Booked',
      features: [
    ...
    },
    {
      ...
      description: 'Luxury 3-bedroom penthouse with panoramic views',
      price: '$750',
      period: '/night',
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed mb-8">
            ...
            Each property offers unparalleled comfort and personalized service.
          </p>
        ...
        <div className="text-center mt-16 max-w-2xl mx-auto">
          ...
          <p className="text-muted-foreground mb-6">
            We offer special rates for monthly stays and corporate housing. Our team will customize
            your Miami Beach experience with personalized amenities and services.
          </p>
          <Button variant="outline" size="lg">
            Discuss Custom Rates
          </Button>
        </div>
      </div>
    </section>
