...
import { ArrowRight, MapPin, Star, Calendar, Shield } from 'lucide-react';

export default function Cta() {
  const stats = [
    { value: '6', label: 'Luxury Properties', icon: MapPin },
    { value: '4.9★', label: 'Guest Rating', icon: Star },
    { value: '500+', label: 'Happy Guests', icon: Shield },
    { value: '24/7', label: 'Concierge', icon: Calendar },
  ];
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Experience luxury beachfront living with our curated collection of premium
                apartments. Personalized service, prime locations, and unforgettable ocean views.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Reserve your beachfront escape in just a few clicks
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                24/7 concierge and personalized guest experiences
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Steps from Miami Beach's finest dining and attractions
              </p>
            </div>
          </div>
        </div>
